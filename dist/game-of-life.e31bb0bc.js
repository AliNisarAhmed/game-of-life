...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var $author$project$Main$BuiltInPattern = function (a) {
	return {$: 'BuiltInPattern', a: a};
};
var $author$project$Main$Closed = {$: 'Closed'};
var $author$project$Main$ClosedSettings = {$: 'ClosedSettings'};
var $author$project$Main$Init = {$: 'Init'};
var $author$project$Main$Normal = {$: 'Normal'};
var $author$project$Patterns$Oscillator = {$: 'Oscillator'};
var $author$project$Patterns$defaultPattern = $author$project$Patterns$Oscillator;
var $author$project$Patterns$oscillator = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				_Utils_Tuple2(midHeight - 1, midWidth),
				_Utils_Tuple2(midHeight, midWidth),
				_Utils_Tuple2(midHeight + 1, midWidth)
			]);
	});
var $author$project$Patterns$defaultPatternFunction = $author$project$Patterns$oscillator;
var $author$project$Rules$Rule = F2(
	function (a, b) {
		return {$: 'Rule', a: a, b: b};
	});
var $author$project$Rules$gameOfLifeRule = A2(
	$author$project$Rules$Rule,
	_List_fromArray(
		[3]),
	_List_fromArray(
		[2, 3]));
var $author$project$Rules$defaultRule = $author$project$Rules$gameOfLifeRule;
...
var $author$project$Main$init = function (_v0) {
	var initialWidth = _v0.initialWidth;
	var images = _v0.images;
	var initialHeight = 70;
	var initialBoard = A2($author$project$Patterns$defaultPatternFunction, initialWidth, initialHeight);
	return _Utils_Tuple2(
		{
			board: initialBoard,
			bookStatus: $mdgriffith$elm_animator$Animator$init($author$project$Main$Closed),
			cellSize: 10.0,
			generations: 0,
			height: initialHeight,
			images: images,
			mode: $author$project$Main$Init,
			pattern: $author$project$Main$BuiltInPattern($author$project$Patterns$defaultPattern),
			rule: $author$project$Rules$defaultRule,
			settingsStatus: $author$project$Main$ClosedSettings,
			speed: $author$project$Main$Normal,
			width: initialWidth
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Main$AnimatorSubscriptionMsg = function (a) {
	return {$: 'AnimatorSubscriptionMsg', a: a};
};
...
var $author$project$Main$speedToValue = function (speed) {
	switch (speed.$) {
		case 'Slow':
			return 10;
		case 'Normal':
...
var $author$project$Main$subscriptions = function (model) {
	...
	switch (_v0.$) {
		case 'Init':
			return A3($mdgriffith$elm_animator$Animator$toSubscription, $author$project$Main$AnimatorSubscriptionMsg, model, $author$project$Main$animator);
		case 'Pause':
			return A3($mdgriffith$elm_animator$Animator$toSubscription, $author$project$Main$AnimatorSubscriptionMsg, model, $author$project$Main$animator);
		default:
			return A2(
				$elm$time$Time$every,
				2000 / $author$project$Main$speedToValue(model.speed),
...
var $author$project$Main$isNeighbour = F2(
	function (_v0, _v1) {
		var i = _v0.a;
		var j = _v0.b;
		var m = _v1.a;
		var n = _v1.b;
		return (_Utils_eq(i - 1, m) && _Utils_eq(j - 1, n)) || ((_Utils_eq(i - 1, m) && _Utils_eq(j, n)) || ((_Utils_eq(i - 1, m) && _Utils_eq(j + 1, n)) || ((_Utils_eq(i, m) && _Utils_eq(j - 1, n)) || ((_Utils_eq(i, m) && _Utils_eq(j + 1, n)) || ((_Utils_eq(i + 1, m) && _Utils_eq(j - 1, n)) || ((_Utils_eq(i + 1, m) && _Utils_eq(j, n)) || (_Utils_eq(i + 1, m) && _Utils_eq(j + 1, n))))))));
	});
var $author$project$Main$countLiveNeighbours = F2(
	function (board, coord) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (x, acc) {
					return A2($author$project$Main$isNeighbour, x, coord) ? (acc + 1) : acc;
				}),
			0,
			board);
	});
...
var $author$project$Main$neighFunctions = _List_fromArray(
	[
		function (_v0) {
		var r = _v0.a;
		var c = _v0.b;
		return _Utils_Tuple2(r - 1, c - 1);
	},
		function (_v1) {
		var r = _v1.a;
		var c = _v1.b;
		return _Utils_Tuple2(r - 1, c);
	},
		function (_v2) {
		var r = _v2.a;
		var c = _v2.b;
...
var $author$project$Main$births = F2(
	function (born, board) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (x, result) {
					var validNeighbs = A3(
						...
						F2(
							function (f, acc) {
								var neighbour = f(x);
								return ((!A2($elm$core$List$member, neighbour, board)) && ((!A2($elm$core$List$member, neighbour, result)) && A2(
									$elm$core$List$member,
									A2($author$project$Main$countLiveNeighbours, board, neighbour),
									born))) ? A2($elm$core$List$cons, neighbour, acc) : acc;
							}),
						_List_Nil,
						$author$project$Main$neighFunctions);
					return _Utils_ap(validNeighbs, result);
				}),
			_List_Nil,
			board);
	});
var $author$project$Main$survivors = F2(
	function (bornRules, board) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (x, acc) {
					return A2(
						$elm$core$List$member,
						A2($author$project$Main$countLiveNeighbours, board, x),
						bornRules) ? A2($elm$core$List$cons, x, acc) : acc;
				}),
			_List_Nil,
			board);
	});
var $author$project$Main$applyGameOfLifeRules = F2(
	function (_v0, board) {
		var birthRules = _v0.a;
		var surviveRules = _v0.b;
		return _Utils_ap(
			A2($author$project$Main$births, birthRules, board),
			A2($author$project$Main$survivors, surviveRules, board));
	});
...
var $author$project$Main$applyRulesFiveTimes = function (rule) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Main$applyGameOfLifeRules(rule),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Main$applyGameOfLifeRules(rule),
			A2(
...
var $author$project$Main$decreaseSpeed = function (spd) {
	switch (spd.$) {
		case 'Fast':
...
var $author$project$Patterns$patternToString = function (ptr) {
	switch (ptr.$) {
		case 'Oscillator':
			return 'Oscillator';
		case 'Glider':
...
var $author$project$Patterns$Acorn = {$: 'Acorn'};
var $author$project$Patterns$DieHard = {$: 'DieHard'};
var $author$project$Patterns$Glider = {$: 'Glider'};
var $author$project$Patterns$GosperGliderGun = {$: 'GosperGliderGun'};
var $author$project$Patterns$RPentomino = {$: 'RPentomino'};
var $author$project$Patterns$Talker = {$: 'Talker'};
var $author$project$Patterns$Toad = {$: 'Toad'};
var $author$project$Patterns$acorn = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				_Utils_Tuple2(midHeight - 2, midWidth + 18),
				_Utils_Tuple2(midHeight - 1, midWidth + 20),
				_Utils_Tuple2(midHeight, midWidth + 17),
				_Utils_Tuple2(midHeight, midWidth + 18),
				_Utils_Tuple2(midHeight, midWidth + 21),
				_Utils_Tuple2(midHeight, midWidth + 22),
				_Utils_Tuple2(midHeight, midWidth + 23)
			]);
	});
var $author$project$Patterns$dieHard = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				_Utils_Tuple2(midHeight, midWidth - 3),
				_Utils_Tuple2(midHeight, midWidth - 2),
				_Utils_Tuple2(midHeight, midWidth + 3),
				_Utils_Tuple2(midHeight + 1, midWidth - 2),
				_Utils_Tuple2(midHeight + 1, midWidth + 2),
				_Utils_Tuple2(midHeight + 1, midWidth + 3),
				_Utils_Tuple2(midHeight + 1, midWidth + 4)
			]);
	});
...
var $author$project$Patterns$glider = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				...
				_Utils_Tuple2(midHeight, midWidth - 2),
				_Utils_Tuple2(midHeight, midWidth),
				_Utils_Tuple2(midHeight + 1, midWidth - 1),
				_Utils_Tuple2(midHeight + 1, midWidth)
			]);
	});
var $author$project$Patterns$gosperGliderGun = F2(
	function (width, height) {
		return _List_fromArray(
			[
				_Utils_Tuple2(1, 25),
...
var $author$project$Patterns$rPentomino = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				_Utils_Tuple2(midHeight - 1, midWidth),
				_Utils_Tuple2(midHeight - 1, midWidth + 1),
				_Utils_Tuple2(midHeight, midWidth - 1),
				_Utils_Tuple2(midHeight, midWidth),
				_Utils_Tuple2(midHeight + 1, midWidth)
			]);
	});
var $author$project$Patterns$talker = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
			[
				_Utils_Tuple2(midHeight - 2, midWidth - 2),
				_Utils_Tuple2(midHeight - 1, midWidth),
				_Utils_Tuple2(midHeight, midWidth - 3),
				_Utils_Tuple2(midHeight, midWidth - 2),
				_Utils_Tuple2(midHeight, midWidth - 1),
...
var $author$project$Patterns$toad = F2(
	function (width, height) {
		var midWidth = (width / 2) | 0;
		var midHeight = (height / 2) | 0;
		return _List_fromArray(
...
var $author$project$Patterns$patterns = A2(
	$edkv$elm_generic_dict$GenericDict$fromList,
	$author$project$Patterns$patternToString,
	_List_fromArray(
		[
			_Utils_Tuple2($author$project$Patterns$Oscillator, $author$project$Patterns$oscillator),
			_Utils_Tuple2($author$project$Patterns$Toad, $author$project$Patterns$toad),
			_Utils_Tuple2($author$project$Patterns$Glider, $author$project$Patterns$glider),
			_Utils_Tuple2($author$project$Patterns$DieHard, $author$project$Patterns$dieHard),
			_Utils_Tuple2($author$project$Patterns$RPentomino, $author$project$Patterns$rPentomino),
			_Utils_Tuple2($author$project$Patterns$Acorn, $author$project$Patterns$acorn),
			_Utils_Tuple2($author$project$Patterns$Talker, $author$project$Patterns$talker),
			_Utils_Tuple2($author$project$Patterns$GosperGliderGun, $author$project$Patterns$gosperGliderGun)
		]));
var $author$project$Patterns$getPattern = function (ptr) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Patterns$defaultPatternFunction,
		A3($edkv$elm_generic_dict$GenericDict$get, $author$project$Patterns$patternToString, ptr, $author$project$Patterns$patterns));
};
var $author$project$Rules$GameOfLife = {$: 'GameOfLife'};
var $author$project$Rules$HighLife = {$: 'HighLife'};
var $elm$core$String$concat = function (strings) {
	return A2($elm$core$String$join, '', strings);
};
var $author$project$Rules$ruleDescription = function (_v0) {
	var born = _v0.a;
	var survive = _v0.b;
	var s = $elm$core$String$concat(
		A2($elm$core$List$map, $elm$core$String$fromInt, survive));
	var b = $elm$core$String$concat(
		A2($elm$core$List$map, $elm$core$String$fromInt, born));
	return '\"B' + (b + ('\" means that a cell is born if exactly 3 of its neighbours are alive. \"S' + (s + '\" means that a cell survives to the next generation if exactly 2 or 3 of its neighbours are alive, else it dies')));
};
var $author$project$Rules$gameOfLifeDescription = 'The original game of life rules as formulated by Mr. John Conway. ' + $author$project$Rules$ruleDescription($author$project$Rules$gameOfLifeRule);
var $author$project$Rules$highLifeRule = A2(
	$author$project$Rules$Rule,
	_List_fromArray(
		[3, 6]),
	_List_fromArray(
		[2, 3]));
var $author$project$Rules$halfLifeDescription = 'HighLife is a cellular automator similar to Conway\'s Game of Life. It was devised in 1994 by Nathan Thompson. ' + $author$project$Rules$ruleDescription($author$project$Rules$highLifeRule);
var $author$project$Rules$rulesList = _List_fromArray(
	[
		_Utils_Tuple2(
		$author$project$Rules$GameOfLife,
		_Utils_Tuple2($author$project$Rules$gameOfLifeRule, $author$project$Rules$gameOfLifeDescription)),
		_Utils_Tuple2(
		$author$project$Rules$HighLife,
		_Utils_Tuple2($author$project$Rules$highLifeRule, $author$project$Rules$halfLifeDescription))
	]);
var $author$project$Rules$rulesToString = function (rules) {
	if (rules.$ === 'GameOfLife') {
...
var $author$project$Rules$rulesDict = A2($edkv$elm_generic_dict$GenericDict$fromList, $author$project$Rules$rulesToString, $author$project$Rules$rulesList);
var $author$project$Rules$getRule = function (label) {
	return A2(
		$elm$core$Maybe$map,
		$elm$core$Tuple$first,
		A3($edkv$elm_generic_dict$GenericDict$get, $author$project$Rules$rulesToString, label, $author$project$Rules$rulesDict));
};
...
var $author$project$Main$increaseSpeed = function (spd) {
	switch (spd.$) {
		case 'Slow':
			return $author$project$Main$Normal;
		case 'Normal':
...
var $author$project$Main$toggleBookStatus = function (bs) {
	if (bs.$ === 'Open') {
...
var $author$project$Main$toggleSettingsStatus = function (s) {
	if (s.$ === 'OpenSettings') {
		return $author$project$Main$ClosedSettings;
	} else {
		return $author$project$Main$OpenSettings;
	}
};
...
var $author$project$Main$updateCell = F2(
	function (coords, currentlyAlive) {
		return A2($elm$core$List$member, coords, currentlyAlive) ? A2(
			$elm$core$List$filter,
			function (c) {
				return !_Utils_eq(c, coords);
			},
			currentlyAlive) : A2($elm$core$List$cons, coords, currentlyAlive);
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CellGridMsg':
				var cellMsg = msg.a;
				if (_Utils_eq(model.mode, $author$project$Main$Init)) {
					var coordinates = _Utils_Tuple2(cellMsg.cell.row, cellMsg.cell.column);
					var updatedDict = A2($author$project$Main$updateCell, coordinates, model.board);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								board: updatedDict,
								pattern: $author$project$Main$Custom(updatedDict)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'Tick':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: A2($author$project$Main$applyGameOfLifeRules, model.rule, model.board),
			...
			case 'IncreaseSpeed':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							speed: $author$project$Main$increaseSpeed(model.speed)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DecreaseSpeed':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							speed: $author$project$Main$decreaseSpeed(model.speed)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeMode':
				var prevMode = msg.a;
				var newMode = function () {
					switch (prevMode.$) {
						case 'Init':
							return $author$project$Main$Play;
						case 'Play':
			...
			case 'ChangePattern':
				var ptr = msg.a;
				var newBoard = A3($author$project$Patterns$getPattern, ptr, model.width, model.height);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: newBoard,
							bookStatus: A3($mdgriffith$elm_animator$Animator$go, $mdgriffith$elm_animator$Animator$quickly, $author$project$Main$Closed, model.bookStatus),
							pattern: $author$project$Main$BuiltInPattern(ptr)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				var newBoard = function () {
					var _v2 = model.pattern;
					if (_v2.$ === 'BuiltInPattern') {
						var ptr = _v2.a;
						return A3($author$project$Patterns$getPattern, ptr, model.width, model.height);
					} else {
						var customPtr = _v2.a;
						return customPtr;
					}
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{board: newBoard, generations: 0, mode: $author$project$Main$Init}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeWidth':
				var n = msg.a;
				return _Utils_Tuple2(
			...
			case 'ChangeHeight':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{height: model.height + n}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleBookStatus':
				var newBookStatus = $author$project$Main$toggleBookStatus(
					$mdgriffith$elm_animator$Animator$current(model.bookStatus));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bookStatus: A3($mdgriffith$elm_animator$Animator$go, $mdgriffith$elm_animator$Animator$quickly, newBookStatus, model.bookStatus)
						}),
					$elm$core$Platform$Cmd$none);
			case 'AnimatorSubscriptionMsg':
				var newTime = msg.a;
				return _Utils_Tuple2(
					A3($mdgriffith$elm_animator$Animator$update, newTime, $author$project$Main$animator, model),
					$elm$core$Platform$Cmd$none);
			case 'ForwardFiveSteps':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							board: A2($author$project$Main$applyRulesFiveTimes, model.rule, model.board),
							generations: model.generations + 5
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleSettings':
				var newSettingsStatus = $author$project$Main$toggleSettingsStatus(model.settingsStatus);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{settingsStatus: newSettingsStatus}),
					$elm$core$Platform$Cmd$none);
			default:
				var label = msg.a;
				var newRule = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Rules$defaultRule,
					$author$project$Rules$getRule(label));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{rule: newRule, settingsStatus: $author$project$Main$ClosedSettings}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Styles$backgroundColor = A3($mdgriffith$elm_ui$Element$rgb255, 24, 36, 43);
...
var $author$project$Styles$container = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$backgroundColor)
	]);
...
var $author$project$Styles$bookStyles = _List_fromArray(
	[
...
var $author$project$Main$ChangePattern = function (a) {
	return {$: 'ChangePattern', a: a};
};
...
var $author$project$Main$findPatternImageFile = F2(
	function (images, ptr) {
		var patternName = $author$project$Patterns$patternToString(ptr);
		var maybeImage = A2(
			$elm$core$Maybe$map,
			function ($) {
				return $.file;
			...
			A2(
				...
				function (_v0) {
					var name = _v0.name;
					return _Utils_eq(name, patternName);
				},
				images));
		return maybeImage;
	});
...
var $author$project$Patterns$patternKeys = $edkv$elm_generic_dict$GenericDict$keys($author$project$Patterns$patterns);
var $author$project$Main$placeholderImage = 'https://via.placeholder.com/300';
...
var $author$project$Main$patternInfoBoxes = function (images) {
	return A2(
		$elm$core$List$map,
		function (pattern) {
			return A2(
				...
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Element$spacingXY, 10, 5)
					]),
				_List_fromArray(
					[
						A2(
							...
							]),
						{
							label: A2(
									...
									]),
								{
									...
									src: A2(
										$elm$core$Maybe$withDefault,
										$author$project$Main$placeholderImage,
										A2($author$project$Main$findPatternImageFile, images, pattern))
								}),
							onPress: $elm$core$Maybe$Just(
								$author$project$Main$ChangePattern(pattern))
						}),
						$mdgriffith$elm_ui$Element$text(
						$author$project$Patterns$patternToString(pattern))
					]));
		},
		$author$project$Patterns$patternKeys);
};
var $mdgriffith$elm_animator$Animator$Css$Movement = F3(
	function (a, b, c) {
		return {$: 'Movement', a: a, b: b, c: c};
	});
...
var $author$project$Main$openBook = F2(
	function (bs, images) {
		return A4(
			...
			_List_fromArray(
				[
					...
					'transform',
					function (f) {
						return (!f) ? 'translateX(100%);' : ((f === 1) ? 'translateX(0%);' : '');
					},
					function (state) {
						if (state.$ === 'Open') {
							return $mdgriffith$elm_animator$Animator$at(1);
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class('openBook')
				]),
			_List_fromArray(
				[
					A3(
					...
					$author$project$Styles$bookStyles,
					A2(
						$mdgriffith$elm_ui$Element$wrappedRow,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Element$spacingXY, 50, 20),
								$mdgriffith$elm_ui$Element$centerY
							]),
						$author$project$Main$patternInfoBoxes(images)))
				]));
	});
var $author$project$Main$bookContainer = F2(
	function (bs, images) {
		var pointerEvents = function () {
			var _v0 = $mdgriffith$elm_animator$Animator$current(bs);
			if (_v0.$ === 'Closed') {
				return A2($elm$html$Html$Attributes$style, 'pointer-events', 'none');
			} else {
				return A2($elm$html$Html$Attributes$style, '', '');
			}
		}();
		var bookElement = A2($author$project$Main$openBook, bs, images);
			...
			A4(
				...
				_List_fromArray(
					[
						...
						pointerEvents,
						$elm$html$Html$Attributes$class('bookContainer')
					]),
				_List_fromArray(
					[bookElement])));
	});
var $author$project$Main$displayBook = F2(
	function (bs, images) {
		return A2($author$project$Main$bookContainer, bs, images);
	});
...
var $author$project$Styles$white = A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
var $author$project$Styles$textStyles = _List_fromArray(
	[
...
var $author$project$Main$displayGeneration = function (generations) {
	...
	return (!generations) ? A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(
				'Generations: ' + $elm$core$String$fromInt(generations))
			]));
};
var $author$project$Main$hiddenSettings = A2($elm$html$Html$div, _List_Nil, _List_Nil);
var $author$project$Main$ChangeRule = function (a) {
	return {$: 'ChangeRule', a: a};
};
...
var $author$project$Styles$heading = _List_fromArray(
	[
...
var $author$project$Styles$primaryColor = A3($mdgriffith$elm_ui$Element$rgb255, 87, 22, 206);
var $author$project$Styles$paragraph = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$alignLeft,
		$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$primaryColor),
		$mdgriffith$elm_ui$Element$Font$size(14)
	]);
var $author$project$Styles$ruleElementStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
	]);
var $author$project$Styles$subHeading = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$alignLeft,
		$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$primaryColor),
		$mdgriffith$elm_ui$Element$Font$size(16)
	]);
var $author$project$Main$ruleElement = F3(
	function (label, _v0, description) {
		var born = _v0.a;
		var survive = _v0.b;
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			$author$project$Styles$ruleElementStyles,
			{
				label: A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text(
								$author$project$Rules$rulesToString(label))),
							A2(
							$mdgriffith$elm_ui$Element$el,
							$author$project$Styles$subHeading,
							$mdgriffith$elm_ui$Element$text(
								'B' + ($elm$core$String$concat(
									A2(
										$elm$core$List$map,
										function (b) {
											return $elm$core$String$fromInt(b);
										},
										born)) + ('S' + $elm$core$String$concat(
									A2(
										$elm$core$List$map,
										function (s) {
							...
							A2(
								...
								$author$project$Styles$paragraph,
								_List_fromArray(
									[
				...
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$ChangeRule(label))
			});
	});
...
var $author$project$Styles$ruleRowStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A4($mdgriffith$elm_ui$Element$rgba255, 180, 180, 180, 0.4))
			]))
	]);
var $author$project$Main$ruleList = A2(
	$elm$core$List$map,
	function (_v0) {
		var label = _v0.a;
		var _v1 = _v0.b;
		var rule = _v1.a;
		var ruleDescription = _v1.b;
		return A2(
			$mdgriffith$elm_ui$Element$row,
			$author$project$Styles$ruleRowStyles,
			_List_fromArray(
				[
					A3($author$project$Main$ruleElement, label, rule, ruleDescription)
				]));
	},
	$author$project$Rules$rulesList);
var $author$project$Styles$settingsStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$spaceEvenly,
...
var $author$project$Main$openSettings = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
			A2($elm$html$Html$Attributes$style, 'left', '0px'),
			A2($elm$html$Html$Attributes$style, 'top', '0px'),
			A2($elm$html$Html$Attributes$style, 'right', '70%'),
			A2($elm$html$Html$Attributes$style, 'bottom', '0px'),
			A2($elm$html$Html$Attributes$style, 'flex-wrap', 'wrap'),
			A2($elm$html$Html$Attributes$style, 'align-items', 'flex-start'),
			A2($elm$html$Html$Attributes$style, 'justify-content', 'space-between'),
	...
	_List_fromArray(
		[
			...
			$author$project$Styles$settingsStyles,
			A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				$author$project$Main$ruleList))
		]));
var $author$project$Main$displaySettings = function (settingsStatus) {
	var settingsElement = function () {
		if (settingsStatus.$ === 'OpenSettings') {
			return $author$project$Main$openSettings;
		} else {
			return $author$project$Main$hiddenSettings;
		}
	}();
	var pointerEvents = function () {
		if (settingsStatus.$ === 'ClosedSettings') {
			return A2($elm$html$Html$Attributes$style, 'pointer-events', 'none');
		} else {
			return A2($elm$html$Html$Attributes$style, '', '');
		}
...
var $author$project$Main$ForwardFiveSteps = {$: 'ForwardFiveSteps'};
...
var $1602$elm_feather$FeatherIcons$chevronsRight = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$class('feather feather-chevrons-right')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Styles$iconStyles = _List_fromArray(
	[
		$elm$svg$Svg$Attributes$color('#ffffff')
	]);
...
var $author$project$Icons$travelForwardFastIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2(
			$1602$elm_feather$FeatherIcons$withClass,
			'icon',
			A2($1602$elm_feather$FeatherIcons$withSize, 20, $1602$elm_feather$FeatherIcons$chevronsRight))));
...
var $author$project$Icons$travelForwardIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2(
			$1602$elm_feather$FeatherIcons$withClass,
			'icon',
			A2($1602$elm_feather$FeatherIcons$withSize, 20, $1602$elm_feather$FeatherIcons$chevronRight))));
var $author$project$Main$displayTimeTravelControls = F2(
	function (generations, mode) {
		...
		return ((!generations) || (!_Utils_eq(mode, $author$project$Main$Pause))) ? A2(
			$mdgriffith$elm_ui$Element$row,
			styles,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$title('Forward 1 step')),
							$mdgriffith$elm_ui$Element$alignRight
						]),
					{
						label: $author$project$Icons$travelForwardIcon,
						onPress: $elm$core$Maybe$Just(
							$author$project$Main$Tick(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$title('Forward 5 steps')),
							$mdgriffith$elm_ui$Element$alignRight
						]),
					{
						label: $author$project$Icons$travelForwardFastIcon,
						onPress: $elm$core$Maybe$Just($author$project$Main$ForwardFiveSteps)
					})
				]));
	});
var $author$project$Main$CellGridMsg = function (a) {
	return {$: 'CellGridMsg', a: a};
};
...
var $jxxcarlson$elm_cell_grid$CellGrid$Render$toCssString = function (color) {
	var roundTo = function (x) {
		return $elm$core$Basics$round(x * 1000) / 1000;
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$jxxcarlson$elm_cell_grid$CellGrid$Render$toCssString(
						style.toColor(value))),
					$elm$svg$Svg$Attributes$stroke(
					$jxxcarlson$elm_cell_grid$CellGrid$Render$toCssString(style.gridLineColor)),
...
var $jxxcarlson$elm_cell_grid$CellGrid$Render$asSvg = F2(
		...
		var elements = A3(
			...
			A2(
				...
				F2(
					function (i, j) {
						return A2(
							$jxxcarlson$elm_cell_grid$CellGrid$Render$renderCell,
							style,
							A2($jxxcarlson$elm_cell_grid$CellGrid$Position, i, j));
					}),
				cellGrid));
		return A2($elm$svg$Svg$g, _List_Nil, elements);
	});
var $jxxcarlson$elm_cell_grid$CellGrid$Render$asHtml = F3(
	function (_v0, cr, cellGrid) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A2($jxxcarlson$elm_cell_grid$CellGrid$Render$asSvg, cr, cellGrid)
				]));
	});
var $author$project$Main$Occupied = {$: 'Occupied'};
var $author$project$Main$UnOccupied = {$: 'UnOccupied'};
var $author$project$Main$getBoxStatus = F3(
	function (board, i, j) {
		return A2(
			$elm$core$List$member,
			_Utils_Tuple2(i, j),
			board) ? $author$project$Main$Occupied : $author$project$Main$UnOccupied;
	});
var $avh4$elm_color$Color$gray = A4($avh4$elm_color$Color$RgbaSpace, 211 / 255, 215 / 255, 207 / 255, 1.0);
var $author$project$Styles$gray = $avh4$elm_color$Color$gray;
...
var $author$project$Styles$occupiedColor = A3($avh4$elm_color$Color$rgb255, 0, 0, 0);
var $author$project$Styles$unOccupiedColor = A3($avh4$elm_color$Color$rgb255, 245, 245, 245);
var $author$project$Main$toColor = function (box) {
	if (box.$ === 'Occupied') {
		return $author$project$Styles$occupiedColor;
	} else {
		return $author$project$Styles$unOccupiedColor;
	}
};
var $author$project$Main$drawGrid = F5(
	function (height, width, cellSize, board, mode) {
		var dimensions = {
			height: height * $elm$core$Basics$round(cellSize),
			width: width * $elm$core$Basics$round(cellSize)
		};
		var cellStyle = {cellHeight: cellSize, cellWidth: cellSize, gridLineColor: $author$project$Styles$gray, gridLineWidth: 1, toColor: $author$project$Main$toColor};
		var cellGrid = A2(
			$jxxcarlson$elm_cell_grid$CellGrid$initialize,
			{columns: width, rows: height},
			$author$project$Main$getBoxStatus(board));
		return $mdgriffith$elm_ui$Element$html(
			A2(
				$elm$html$Html$map,
				$author$project$Main$CellGridMsg,
				A3($jxxcarlson$elm_cell_grid$CellGrid$Render$asHtml, dimensions, cellStyle, cellGrid)));
	});
var $author$project$Main$getPatternName = function (ip) {
	if (ip.$ === 'BuiltInPattern') {
		var ptr = ip.a;
		return $author$project$Patterns$patternToString(ptr);
	} else {
		return 'Custom';
	}
};
var $author$project$Styles$gridContainer = _List_fromArray(
	[
...
var $author$project$Styles$gridLayout = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$centerY,
		$mdgriffith$elm_ui$Element$centerX,
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Styles$gridStyles = _List_fromArray(
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Styles$layout = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
	]);
var $author$project$Styles$patternDisplayStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$centerY,
		$mdgriffith$elm_ui$Element$centerX,
		$mdgriffith$elm_ui$Element$alignLeft,
...
var $author$project$Main$ToggleBookStatus = {$: 'ToggleBookStatus'};
...
var $author$project$Icons$crossIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$x)));
...
var $author$project$Icons$menuIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$menu)));
var $author$project$Main$bookIcon = function (bs) {
	if (bs.$ === 'Closed') {
		return $author$project$Icons$menuIcon;
	} else {
		return $author$project$Icons$crossIcon;
	}
};
var $author$project$Styles$sidebarIconStyles = _List_fromArray(
	[$mdgriffith$elm_ui$Element$centerX]);
var $author$project$Styles$bookIconStyles = _Utils_ap(
	$author$project$Styles$sidebarIconStyles,
	_List_fromArray(
		[
...
var $author$project$Icons$pauseIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2(
			$1602$elm_feather$FeatherIcons$withClass,
			'icon',
			A2($1602$elm_feather$FeatherIcons$withSize, 40, $1602$elm_feather$FeatherIcons$pause))));
...
var $author$project$Icons$playIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2(
			$1602$elm_feather$FeatherIcons$withClass,
			'icon',
			A2($1602$elm_feather$FeatherIcons$withSize, 40, $1602$elm_feather$FeatherIcons$play))));
var $author$project$Main$getModeButtonIcon = function (mode) {
	switch (mode.$) {
		case 'Init':
			return $author$project$Icons$playIcon;
		case 'Play':
			return $author$project$Icons$pauseIcon;
		default:
			return $author$project$Icons$playIcon;
	}
};
...
var $1602$elm_feather$FeatherIcons$refreshCw = A2(
	$1602$elm_feather$FeatherIcons$makeBuilder,
	'refresh-cw',
	_List_fromArray(
		[
...
var $author$project$Icons$resetIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$refreshCw)));
...
var $author$project$Icons$settingsIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$settings)));
var $mdgriffith$elm_ui$Internal$Model$Top = {$: 'Top'};
var $mdgriffith$elm_ui$Element$alignTop = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Top);
var $author$project$Styles$settingsIconStyles = _Utils_ap(
	$author$project$Styles$sidebarIconStyles,
	_List_fromArray(
		[
...
var $author$project$Styles$sidebarColumnStyles = _List_fromArray(
	[
		A2($mdgriffith$elm_ui$Element$spacingXY, 0, 15)
	]);
var $author$project$Styles$sidebarRowStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$centerX,
...
var $author$project$Styles$sidebarStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
		$mdgriffith$elm_ui$Element$width(
		...
		$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$primaryColor),
		A2($mdgriffith$elm_ui$Element$paddingXY, 0, 10),
		$mdgriffith$elm_ui$Element$centerX,
		$mdgriffith$elm_ui$Element$centerY,
		...
		{
			blur: 10.0,
			color: $author$project$Styles$primaryColor,
			offset: _Utils_Tuple2(2.0, 2.0),
			size: 2.0
		})
	]);
var $author$project$Main$sidebar = F3(
	function (mode, speed, bookStatus) {
		var toggleSettingsButton = A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_Nil,
			{
				label: $author$project$Icons$settingsIcon,
				onPress: $elm$core$Maybe$Just($author$project$Main$ToggleSettings)
			});
		var toggleBookStatusButton = A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_Nil,
			{
				label: $author$project$Main$bookIcon(bookStatus),
				onPress: $elm$core$Maybe$Just($author$project$Main$ToggleBookStatus)
			});
		var playAndResetButtonStyles = _List_fromArray(
			[$mdgriffith$elm_ui$Element$centerX]);
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Styles$sidebarStyles,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$row,
					$author$project$Styles$bookIconStyles,
					_List_fromArray(
						[toggleBookStatusButton])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					$author$project$Styles$settingsIconStyles,
					_List_fromArray(
						[toggleSettingsButton])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					$author$project$Styles$sidebarRowStyles,
					_List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$column,
							$author$project$Styles$sidebarColumnStyles,
							_List_fromArray(
								[
									A2(
									$mdgriffith$elm_ui$Element$Input$button,
									...
									{
										label: $author$project$Icons$resetIcon,
									...
									playAndResetButtonStyles,
									{
										label: $author$project$Main$getModeButtonIcon(mode),
										onPress: $elm$core$Maybe$Just(
											$author$project$Main$ChangeMode(mode))
									})
								]))
						]))
				]));
	});
var $author$project$Main$DecreaseSpeed = {$: 'DecreaseSpeed'};
var $author$project$Main$IncreaseSpeed = {$: 'IncreaseSpeed'};
var $1602$elm_feather$FeatherIcons$chevronsDown = A2(
	$1602$elm_feather$FeatherIcons$makeBuilder,
	'chevrons-down',
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$strokeLinecap('round'),
					$elm$svg$Svg$Attributes$strokeLinejoin('round'),
					$elm$svg$Svg$Attributes$class('feather feather-chevrons-down')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Icons$decreaseSpeedIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$chevronsDown)));
var $1602$elm_feather$FeatherIcons$chevronsUp = A2(
	$1602$elm_feather$FeatherIcons$makeBuilder,
	'chevrons-up',
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$strokeLinecap('round'),
					$elm$svg$Svg$Attributes$strokeLinejoin('round'),
					$elm$svg$Svg$Attributes$class('feather feather-chevrons-up')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Icons$increaseSpeedIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		$author$project$Styles$iconStyles,
		A2($1602$elm_feather$FeatherIcons$withClass, 'icon', $1602$elm_feather$FeatherIcons$chevronsUp)));
...
var $author$project$Styles$hiddenIcon = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$transparent(true)
	]);
var $author$project$Main$speedControlButtonStyles = function (bookStatus) {
	var commonStyles = _List_fromArray(
		[$mdgriffith$elm_ui$Element$alignLeft]);
	if (bookStatus.$ === 'Open') {
		return _Utils_ap($author$project$Styles$hiddenIcon, commonStyles);
	} else {
		return _Utils_ap($author$project$Styles$sidebarIconStyles, commonStyles);
	}
};
...
var $author$project$Styles$speedControlStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$alignLeft,
...
var $author$project$Main$speedToString = function (spd) {
	switch (spd.$) {
		case 'Slow':
			return 'Slow';
		case 'Normal':
...
var $author$project$Main$speedControl = F2(
	function (speed, bookStatus) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			$author$project$Styles$speedControlStyles,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					$author$project$Main$speedControlButtonStyles(bookStatus),
					{
						label: $author$project$Icons$increaseSpeedIcon,
						onPress: $elm$core$Maybe$Just($author$project$Main$IncreaseSpeed)
					}),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_Utils_ap(
					...
					$mdgriffith$elm_ui$Element$text(
						$author$project$Main$speedToString(speed))),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					$author$project$Main$speedControlButtonStyles(bookStatus),
					{
						label: $author$project$Icons$decreaseSpeedIcon,
						onPress: $elm$core$Maybe$Just($author$project$Main$DecreaseSpeed)
					})
				]));
	});
var $author$project$Styles$uiStyles = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$centerX,
		$mdgriffith$elm_ui$Element$centerY,
...
var $author$project$Main$view = function (_v0) {
	var height = _v0.height;
	var width = _v0.width;
	var cellSize = _v0.cellSize;
	var mode = _v0.mode;
	var board = _v0.board;
	var speed = _v0.speed;
	var bookStatus = _v0.bookStatus;
	var pattern = _v0.pattern;
	var generations = _v0.generations;
	var images = _v0.images;
	var settingsStatus = _v0.settingsStatus;
	var settings = $mdgriffith$elm_ui$Element$inFront(
		$author$project$Main$displaySettings(settingsStatus));
	var currentBookStatus = $mdgriffith$elm_animator$Animator$current(bookStatus);
	var book = $mdgriffith$elm_ui$Element$inFront(
		A2($author$project$Main$displayBook, bookStatus, images));
	var gridContainerStyles = _Utils_ap(
		$author$project$Styles$gridContainer,
		_Utils_ap(
			_List_fromArray(
				[book]),
			_List_fromArray(
	...
	var content = A2(
		...
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$column,
				$author$project$Styles$uiStyles,
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$Styles$patternDisplayStyles,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								'Current Pattern: ' + $author$project$Main$getPatternName(pattern))
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$Styles$gridLayout,
						_List_fromArray(
							[
								A2(
								$mdgriffith$elm_ui$Element$el,
								$author$project$Styles$gridStyles,
								A5($author$project$Main$drawGrid, height, width, cellSize, board, mode))
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2(
								$author$project$Main$speedControl,
								speed,
								$mdgriffith$elm_animator$Animator$current(bookStatus)),
								$author$project$Main$displayGeneration(generations),
								A2($author$project$Main$displayTimeTravelControls, generations, mode)
							]))
					]))
			]));
	return A2(
		...
		A2(
			...
			A2(
				$mdgriffith$elm_ui$Element$row,
				$author$project$Styles$layout,
				_List_fromArray(
					[
						A3($author$project$Main$sidebar, mode, speed, currentBookStatus),
						content
					]))));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
			...
			return A2(
				...
				function (images) {
					return $elm$json$Json$Decode$succeed(
						{images: images, initialWidth: initialWidth});
				},
				A2(
					$elm$json$Json$Decode$field,
					'images',
		...
		A2($elm$json$Json$Decode$field, 'initialWidth', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"CellGrid.Render.Msg":{"args":[],"type":"{ cell : CellGrid.Position, coordinates : { x : Basics.Float, y : Basics.Float } }"},"CellGrid.Position":{"args":[],"type":"{ row : Basics.Int, column : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"CellGridMsg":["CellGrid.Render.Msg"],"Tick":["Time.Posix"],"ChangeMode":["Main.Mode"],"IncreaseSpeed":[],"DecreaseSpeed":[],"ChangePattern":["Patterns.Pattern"],"ChangeWidth":["Basics.Int"],"ChangeHeight":["Basics.Int"],"ToggleBookStatus":[],"Reset":[],"AnimatorSubscriptionMsg":["Time.Posix"],"ForwardFiveSteps":[],"ToggleSettings":[],"ChangeRule":["Rules.RuleLabels"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.Mode":{"args":[],"tags":{"Init":[],"Play":[],"Pause":[]}},"Patterns.Pattern":{"args":[],"tags":{"Oscillator":[],"Glider":[],"DieHard":[],"Acorn":[],"Talker":[],"RPentomino":[],"Toad":[],"GosperGliderGun":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Rules.RuleLabels":{"args":[],"tags":{"GameOfLife":[],"HighLife":[]}}}}})}});
...
},{}],"assets/oscillator.png":[function(require,module,exports) {
module.exports = "/oscillator.96e5bd99.png";
},{}],"assets/acorn.png":[function(require,module,exports) {
module.exports = "/acorn.d78f0520.png";
},{}],"assets/diehard.png":[function(require,module,exports) {
module.exports = "/diehard.968069cb.png";
},{}],"assets/glider.png":[function(require,module,exports) {
module.exports = "/glider.c14aea62.png";
},{}],"assets/gosper.png":[function(require,module,exports) {
module.exports = "/gosper.2e332186.png";
},{}],"assets/rpentomino.png":[function(require,module,exports) {
module.exports = "/rpentomino.b2f9f314.png";
},{}],"assets/talker.png":[function(require,module,exports) {
module.exports = "/talker.ca0c8255.png";
},{}],"assets/toad.png":[function(require,module,exports) {
module.exports = "/toad.2edaf2d1.png";
...
var _oscillator = _interopRequireDefault(require("./assets/oscillator.png"));

var _acorn = _interopRequireDefault(require("./assets/acorn.png"));

var _diehard = _interopRequireDefault(require("./assets/diehard.png"));

var _glider = _interopRequireDefault(require("./assets/glider.png"));

var _gosper = _interopRequireDefault(require("./assets/gosper.png"));

var _rpentomino = _interopRequireDefault(require("./assets/rpentomino.png"));

var _talker = _interopRequireDefault(require("./assets/talker.png"));

var _toad = _interopRequireDefault(require("./assets/toad.png"));
...
_Main.Elm.Main.init({
  ...
  flags: {
    ...
    images: [{
      name: 'Oscillator',
      file: _oscillator.default
    }, {
      name: 'Acorn',
      file: _acorn.default
    }, {
      name: 'DieHard',
      file: _diehard.default
    }, {
      name: 'Glider',
      file: _glider.default
    }, {
      name: 'Gosper Glider Gun',
      file: _gosper.default
    }, {
      name: 'RPentomino',
      file: _rpentomino.default
    }, {
      name: 'Talker',
      file: _talker.default
    }, {
      name: 'Toad',
      file: _toad.default
    }]
...
},{"./main.css":"main.css","./src/Main.elm":"src/Main.elm","./assets/oscillator.png":"assets/oscillator.png","./assets/acorn.png":"assets/acorn.png","./assets/diehard.png":"assets/diehard.png","./assets/glider.png":"assets/glider.png","./assets/gosper.png":"assets/gosper.png","./assets/rpentomino.png":"assets/rpentomino.png","./assets/talker.png":"assets/talker.png","./assets/toad.png":"assets/toad.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39905" + '/');
...
//# sourceMappingURL=/game-of-life.e31bb0bc.js.map